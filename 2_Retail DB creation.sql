/*-- Create a NEW DATABASE & DATA MODEL */
...
CREATE TABLE customers (
  ...
  -- Syntax: ALTER TABLE <tablename> ADD PRIMARY KEY (<PRIMARY KEY COLUMN>);
...
-- ALTER TABLE <tablename> ADD constraint <fk_name> Foreign key (<column in the child TABLE >)
-- references <PARENT TABLE NAME> (<PARENT TABLE COLUMN NAME>)
-- fk_name ; fk_tablename_columnname
ALTER TABLE employees
	ADD CONSTRAINT fk_employees_reportsTo -- self-dependency on same table
...
PRIMARY KEY (customerNumber,CheckNumber), -- Compostie PK
...
-- Let's look into DML commands - SELECT, INSERT, UPDATE, DELETE
...
VALUES 
   ...
   ** Note: Number of columns and values should match in the INSERT statement.
*/ 
...
VALUES 
('San Francisco','+1 650 219 4782','100 Makram Street','Suite 311','CA','USA','94080','NA');
  
SELECT * FROM offices;
  
TRUNCATE TABLE offices; -- Error; be careful while truncating or deleting the rows in a table.
